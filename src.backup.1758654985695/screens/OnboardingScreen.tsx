...
export default function OnboardingScreen() {
  ...
  }, [logoScale, logoRotation, titleOpacity, subtitleOpacity, featuresOpacity, buttonScale]); // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  const handleGetStarted = async () => {
    ...
    try {
      ...
      Alert.alert("Error", (error as Error).message || "Something went wrong. Please try again.", [
