    ...
    if (sanitizedUri) {
      ...
      if (applyQualitySelection) {
        try {
          ...
          console.warn("prepareVideoResults: quality selection failed for", sanitizedUri);
...
const getOrSelectVideoQuality = async (
  ...
  try {
    ...
    console.warn("getOrSelectVideoQuality failed");
    return null;
  }
};
...
export class VideoDataService {
  ...
  static async fetchVideoConfessions(limit: number = 20, enableQualitySelection = true): Promise<Confession[]> {
    ...
    try {
      ...
      console.error("VideoDataService.fetchVideoConfessions failed");
  ...
  static async fetchTrendingVideos(
    ...
    try {
      ...
      console.error("VideoDataService.fetchTrendingVideos failed");
  ...
  static async fetchTrendingHashtags(hoursBack: number = 24, limit: number = 10): Promise<TrendingHashtag[]> {
    try {
      ...
      console.error("VideoDataService.fetchTrendingHashtags failed");
      return [];
    }
  }
  ...
  static async searchVideosByHashtag(hashtag: string, limit: number = 20): Promise<Confession[]> {
    ...
    try {
      ...
      console.error("VideoDataService.searchVideosByHashtag failed");
      return [];
    }
  }
  ...
  static async updateVideoLikes(videoId: string, isLiked: boolean): Promise<number | null> {
    ...
    try {
      ...
      console.error("VideoDataService.updateVideoLikes failed");
      return null;
    }
  }
  ...
  static async updateVideoViews(videoId: string): Promise<number | null> {
    ...
    try {
      ...
      if (__DEV__) {
        console.warn("VideoDataService.updateVideoViews failed");
      }
      return null;
    }
  }
  ...
  static async getCommentCount(videoId: string): Promise<number> {
    ...
    try {
      ...
      if (__DEV__) {
        console.warn("VideoDataService.getCommentCount failed");
      }
      return 0;
    }
  }
  ...
  static async processEventQueue(videoId: string): Promise<void> {
    ...
    try {
      ...
      console.error("Failed to process video events");
  ...
  static async intelligentPreload(confessions: Confession[]): Promise<void> {
    try {
      ...
      console.error("Intelligent preload failed");
    }
  }
  ...
  static async aggressivePreload(confessions: Confession[]): Promise<void> {
    ...
    try {
      ...
      console.error("Aggressive preload failed");
    }
  }
  ...
  static async optimizeQualityInBackground(confessions: Confession[]): Promise<void> {
    try {
      ...
      console.error("Failed to enqueue background quality optimization");
    }
  }
  ...
  static async checkQualityUpgrade(videoUri: string): Promise<boolean> {
    try {
      ...
      console.error("Quality upgrade check failed");
      return false;
    }
  }
  ...
  static async getVideoEngagementSummary(
    ...
    try {
      ...
      console.error("Failed to fetch video engagement summary");
      return null;
    }
  }
  ...
  static async getWatchTimeAnalytics(videoId?: string): Promise<{
    ...
    try {
      ...
      console.error("Failed to fetch watch time analytics");
      return null;
    }
  }
  ...
  static async getCompletionRateStats(): Promise<{
    ...
    try {
      ...
      console.error("Failed to fetch completion rate stats");
      return null;
    }
  }
