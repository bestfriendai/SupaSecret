...
function validateEnvironmentVariables() {
  ...
  REQUIRED_ENV_VARS.forEach((envVar) => {
    ...
    const hasPlaceholder = PLACEHOLDER_PATTERNS.some((pattern) => value.includes(pattern));
...
function runAllValidations() {
  ...
  const results = [validateEnvironmentVariables(), validateConfiguration(), validateProductDefinitions()];
