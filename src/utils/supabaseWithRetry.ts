 ...
 */
export const selectWithRetry = async <T = any>(
  table: string,
  query?: string,
 ...
 */
export const insertWithRetry = async <T = any>(
  table: string,
  values: any | any[],
  options?: RetryOptions
) => {
 ...
 */
export const rpcWithRetry = async <T = any>(
  functionName: string,
  params?: any,
  options?: RetryOptions
) => {
 ...
 */
export const wrapWithRetry = <T extends (...args: any[]) => Promise<any>>(
  operation: T,
  options?: RetryOptions
): T => {
  const retry = options ? createSupabaseRetry(options) : defaultRetry;
