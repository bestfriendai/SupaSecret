  ...
  return (
    <View className="py-4">
      ...
      <View className="mb-6">
        <Animated.View 
          style={shimmerStyle}
          className="h-4 bg-gray-700 rounded mb-3 w-32"
        />
      ...
      <View>
        <Animated.View 
          style={shimmerStyle}
          className="h-4 bg-gray-700 rounded mb-3 w-40"
        />
        {[1, 2, 3].map((index) => (
          <View key={index} className="bg-gray-900 rounded-lg p-4 mb-3">
            <View className="flex-row items-center mb-2">
              ...
              <Animated.View 
                style={shimmerStyle}
                className="h-3 bg-gray-700 rounded flex-1"
              />
            </View>
            ...
            <Animated.View 
              style={shimmerStyle}
              className="h-4 bg-gray-700 rounded mb-2 w-4/5"
            />
            <Animated.View 
              style={shimmerStyle}
              className="h-4 bg-gray-700 rounded w-3/5"
            />
            ...
            <View className="flex-row items-center justify-between mt-3">
              <View className="flex-row items-center">
                <Animated.View 
                  style={shimmerStyle}
                  className="w-6 h-6 bg-gray-700 rounded mr-2"
                />
                <Animated.View 
                  style={shimmerStyle}
