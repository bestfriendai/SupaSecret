...
export const BannerAdComponent: React.FC<BannerAdComponentProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ fontSize: 16, color: "#4a9eff", marginBottom: 4 }}>📱 SupaSecret Premium</Text>
        <Text style={{ fontSize: 12, color: "#ccc", textAlign: "center" }}>
          {AdMobService.isExpoGo() ? "Demo Ad - Real ads in dev build" : "Upgrade for ad-free experience"}
        </Text>
      </View>
    </View>
  );
