...
import { View, Text, Pressable, ScrollView, Alert, Linking, Platform, ActivityIndicator } from "react-native";
...
export function SubscriptionManagementScreen() {
  ...
  const { isPremium, subscriptionStatus, isLoading, checkSubscriptionStatus, refreshCustomerInfo, restorePurchases } =
    useSubscription();
    ...
    <View style={{ flex: 1, backgroundColor: "#000000" }}>
      ...
      >
        ...
        >
          ...
          <Text style={{ color: "#9CA3AF", fontSize: 16 }}>Manage your premium membership</Text>
        </View>
        ...
        <View style={{ paddingHorizontal: 20, marginBottom: 32 }}>
          {managementOptions.map((option, index) => (
            ...
            >
              ...
              >
                <Ionicons name={option.icon} size={20} color={option.destructive ? "#FCA5A5" : "#60A5FA"} />
              </View>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: "#9CA3AF", fontSize: 13 }}>{option.description}</Text>
              </View>
