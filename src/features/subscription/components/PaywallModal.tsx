    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      ...
      >
        ...
        >
          ...
          >
            <View style={{ flex: 1 }}>
              <Text style={{ color: "#FFFFFF", fontSize: 24, fontWeight: "bold" }}>Unlock Premium</Text>
              <Text style={{ color: "#9CA3AF", fontSize: 12, marginTop: 2 }}>Get access to all premium features</Text>
            </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={{ marginBottom: 32 }}>
              ...
              {BENEFITS.map((benefit, index) => (
                <View key={index} style={{ flexDirection: "row", alignItems: "center", marginBottom: 12 }}>
                  ...
                  <Text style={{ color: "#F3F4F6", fontSize: 16, flex: 1 }}>{benefit.text}</Text>
                </View>
              ))}
            </View>
                    ...
                    >
                      ...
                      >
                        <View style={{ flex: 1 }}>
                          ...
                          {annual && (
                            <Text style={{ color: "#10B981", fontSize: 12, marginTop: 2 }}>Save 50% vs monthly</Text>
                          )}
                        </View>
                        <View
                          style={{
            ...
            <Pressable
              ...
              style={{
                backgroundColor: isLoading || !selectedPackage || packages.length === 0 ? "#6B7280" : "#10B981",
                borderRadius: 16,
                padding: 16,
                marginBottom: 12,
              }}
