...
import type { FaceBlurOptions, FaceBlurResult, IFaceBlurService } from "../types";
...
export class FaceBlurService implements IFaceBlurService {
  ...
  async processVideo(videoUri: string, options: FaceBlurOptions = {}): Promise<FaceBlurResult> {
    ...
    try {
      ...
      Alert.alert(
        "Face Blur Not Available",
        "Face blur processing is not yet implemented. The original video has been returned.",
      );
