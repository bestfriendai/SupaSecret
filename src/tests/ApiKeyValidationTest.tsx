    ...
    <SafeAreaView className="flex-1 bg-black">
      <View className="px-4 py-3 border-b border-gray-800">
        ...
        <Text className="text-gray-400 text-14 mt-1">
          Check API keys and service integration
        </Text>
      </View>
      ...
      <ScrollView className="flex-1 px-4">
          ...
          {apiKeys.map((apiKey) => (
            <View key={apiKey.key} className="flex-row items-center py-2 border-b border-gray-800">
              ...
              <View className="flex-1">
                ...
                {apiKey.value && (
                  <Text className="text-gray-400 text-11 font-mono">{apiKey.value}</Text>
                )}
              </View>
        ...
        <View className="py-4 border-t border-gray-800">
          ...
          <View className="bg-gray-900 rounded-lg p-3">
            <Text className="text-gray-300 text-14 mb-2">
