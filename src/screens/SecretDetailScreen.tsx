...
import { View, Text, ScrollView, Pressable, TextInput, KeyboardAvoidingView, Platform, Alert, TouchableWithoutFeedback, Keyboard } from "react-native";
          ...
          <View className="flex-row items-center">
            ...
            >
              <Ionicons 
                name="send" 
                size={18} 
                color={newReply.trim() && !isSubmitting ? "#FFFFFF" : "#8B98A5"} 
              />
            </Pressable>
          </View>
        </View>
